...
void DXContext::LogAdapterOutputs(IDXGIAdapter* adapter)
{
	UINT i = 0;
...
void DXContext::LogOutputDisplayModes(IDXGIOutput* output, DXGI_FORMAT format)
{
	UINT count = 0;
	UINT flags = 0;
